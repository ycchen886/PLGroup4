...
./ngram/ngram data/Trump/all_Trump_uni.out data/Trump/all_Trump_bi.out data/Trump/all_Trump_bbi.out data/Trump/all_Trump_tri.out data/Trump/all_Trump_btri.out -num 3 -type SENTENCE 

I mean , how about factory . 
But CNN treats me so disappointed . 
